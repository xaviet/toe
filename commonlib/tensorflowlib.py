...
def ex0(trainTime=256):
  ...
  rt=sess.run(accuracy, feed_dict={x: mnist.test.images, y_: mnist.test.labels})
  print(rt)
  return(rt)
...
def ex2(trainTime=256):
  ...
  rt=accuracy.eval(feed_dict={x: mnist.test.images, y_: mnist.test.labels, keep_prob: 1.0})
  print(rt)
  return(rt)
